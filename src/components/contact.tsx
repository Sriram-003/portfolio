    ...
    <div className="flex flex-col md:flex-row gap-8 max-w-4xl mx-auto">
      <div className="md:w-1/2">
        <form className="flex flex-col gap-4">
          <input
            ...
            className="p-3 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none focus:border-blue-400"
            required
          />
          <input
            type="email"
      ...
      <div className="md:w-1/2 flex flex-col items-center gap-6">
        <div className="flex flex-col gap-4 text-lg">
          <a href="mailto:sriramvenkat2304@gmail.com" className="flex items-center gap-2 hover:text-blue-400 transition">
          ...
          <a href="tel:+918190814835" className="flex items-center gap-2 hover:text-blue-400 transition">
            <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        ...
        <div className="flex gap-6 mt-6">
          <a href="https://linkedin.com/in/sriram-v-241888242" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
            <svg className="w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
              <path fill="#0288D1" d="M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z"/>
              <path fill="#FFF" d="M12 19H17V36H12zM14.485 17h-.028C12.965 17 12 15.888 12 14.499 12 13.08 12.995 12 14.514 12c1.521 0 2.458 1.08 2.486 2.499C17 15.887 16.035 17 14.485 17zM36 36h-5v-9.099c0-2.198-1.225-3.698-3.192-3.698c-1.501 0-2.313 1.012-2.707 1.99C24.957 25.543 25 26.511 25 27v9h-5V19h5v2.616C25.721 20.5 26.85 19 29.738 19c3.578 0 6.261 2.25 6.261 7.274L36 36L36 36z"/>
            </svg>
          </a>
          <a href="https://github.com/Sriram-003" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
            <svg className="w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
              <path fill="currentColor" d="M16 4C9.371 4 4 9.371 4 16c0 5.3 3.438 9.8 8.207 11.386c.601.11.82-.258.82-.577c0-.285-.011-1.039-.015-2.039c-3.34.723-4.043-1.609-4.043-1.609c-.547-1.387-1.332-1.758-1.332-1.758c-1.09-.742.082-.727.082-.727c1.203.086 1.836 1.235 1.836 1.235c1.071 1.836 2.809 1.304 3.492.999c.109-.777.422-1.304.762-1.605c-2.664-.301-5.465-1.332-5.465-5.929c0-1.313.469-2.383 1.235-3.223c-.124-.302-.535-1.52.118-3.168c0 0 1.007-.32 3.3 1.23c.957-.266 1.984-.398 3.003-.402c1.019.004 2.046.136 3.003.402c2.293-1.55 3.3-1.23 3.3-1.23c.656 1.648.244 2.866.119 3.168c.768.84 1.235 1.91 1.235 3.223c0 4.609-2.804 5.625-5.475 5.922c.433.374.817 1.102.817 2.222c0 1.605-.014 2.898-.014 3.293c0 .32.215.693.825.575C24.563 25.8 28 21.3 28 16c0-6.629-5.371-12-12-12Z"/>
            </svg>
          </a>
          <a href="https://techie-tides.blogspot.com" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
            <svg className="w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
              <path fill="#ff6f00" d="M37,42H11c-2.761,0-5-2.239-5-5V11c0-2.761,2.239-5,5-5h26c2.761,0,5,2.239,5,5v26C42,39.761,39.761,42,37,42z"/>
              <path fill="#fff" d="M33.5,22h-1c-0.828,0-1.5-0.672-1.5-1.5V20c0-3.866-3.134-7-7-7h-4c-3.866,0-7,3.134-7,7v8c0,3.866,3.134,7,7,7h8c3.866,0,7-3.134,7-7v-4.5C35,22.672,34.328,22,33.5,22z M20,19h5c0.553,0,1,0.448,1,1s-0.447,1-1,1h-5c-0.553,0-1-0.448-1-1S19.447,19,20,19z M28,29h-8c-0.553,0-1-0.448-1-1s0.447-1,1-1h8c0.553,0,1,0.448,1,1S28.553,29,28,29z"/>
            </svg>
          </a>
        </div>
      </div>
